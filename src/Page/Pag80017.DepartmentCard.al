...
Page 80017 "Department Card"
{
            ...
            group(ActionGroup54)
            {
                action("Copy Company Address")
                {
                    ...
                    begin
                        ...
                        City := CompInfo.City;
                        "Phone No." := CompInfo."Phone No.";
                        "E-Mail" := CompInfo."E-Mail";
                        "Fax No." := CompInfo."Fax No.";
                        "Home Page" := CompInfo."Home Page";
    ...
    begin
        "Operating Unit Type" := "operating unit type"::"Department/Center";
    end;
