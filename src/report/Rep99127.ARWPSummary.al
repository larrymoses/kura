report 99127 "ARWP Summary"
{
    ApplicationArea = All;
    Caption = 'ARWP Summary';
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = './Layouts/ARWPSummary.rdl';
    dataset
    {
        dataitem(RAMWorkplanHeader; "RAM Workplan Header")
        {
            ...
            dataitem("RAM Workplan Line"; "RAM Workplan Line")
            {
                ...
                begin
                    ...
                    if RoadInventory.FindFirst() then begin
                        RoadLength := RoadInventory."End Chainage(KM)" - RoadInventory."Start Chainage(KM)";
                    end;
                end;
            }
            trigger OnAfterGetRecord()
