...
Table 70181 "Bid Tabulation Header"
{
    ...
    fields
    {
        ...
        field(30; "Award Acceptance Deadline"; Code[20])
        {
            ...
            Dur: Duration;
            begin
                Evaluate(Dur,Rec."Award Acceptance Deadline");
                Rec."Award Acceptance Response":= CalcDate("Award Acceptance Deadline", Rec."Document Date");
            end;
           // Editable = false;
        }
        ...
        field(86; "Directorate ID"; Code[50])
        {
