...
Table 69072 "EarningsX Temp-E"
{
    ...
    fields
    {
        ...
        {
            OptionMembers = "Flat amount","% of Basic pay","% of Gross pay","% of Insurance Amount","% of Taxable income","% of Basic after tax","Based on Hourly Rate","Based on Daily Rate","Based on Table";
        }
        ...
        field(50007; "Earnings Table";Code[10])
        {
           TableRelation = "Casuals Earning Bracket Table"."Table Code";
        }
