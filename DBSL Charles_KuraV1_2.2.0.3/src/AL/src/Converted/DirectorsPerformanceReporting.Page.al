    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Q1 Actual Qty"; "Q1 Actual Qty")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Q2 Actual Qty"; "Q2 Actual Qty")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Q3 Actual Qty"; "Q3 Actual Qty")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Q4 Actual Qty"; "Q4 Actual Qty")
                {
                    ApplicationArea = Basic;
                }
...
;
    ...
    begin
        ...
        CalcFields("Q1 Actual Qty", "Q2 Actual Qty", "Q3 Actual Qty", "Q4 Actual Qty");
        Q1Variance := ("Q1 Target Qty" - "Q1 Actual Qty");

        Q2Variance := ("Q2 Target Qty" - "Q2 Actual Qty");
        Q2Cumulative := ("Q1 Actual Qty" + "Q2 Actual Qty");

        Q3Variance := ("Q3 Target Qty" - "Q3 Actual Qty");
        Q2Cumulative := ("Q1 Actual Qty" + "Q2 Actual Qty" + "Q3 Actual Qty");

        Q4Variance := ("Q4 Target Qty" - "Q4 Actual Qty");
        Q4Cumulative := ("Q4 Actual Qty" + "Q4 Actual Qty" + "Q4 Actual Qty");
    end;
