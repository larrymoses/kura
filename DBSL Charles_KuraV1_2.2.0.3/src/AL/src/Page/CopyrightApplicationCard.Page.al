            ...
            group("Function")
            {
                    ...
                    begin
                        ...
                        if "ID. No." <> '' then begin
                            ...
                            if Cust.Find('-') then begin
                                if Cust."No." <> "Applicant Account" then
                                    Error(Text006);
                            end;
                        end;
                ...
                action("Cancel Approval Request")
                {
                    ...
                    begin
                        ...
                        TestField(Status, Status::Pending);//status must be open.
                        TestField("Captured by", UserId); //control so that only the initiator of the document can send for approval
                    ...
                    begin
                        ...
                        if categoriesNoSetup.FindSet then begin
                            ...
                            if Confirm(Text009, false) = true then begin
                                ...
                                Service."No." := worksNo;
                                Service."Copyright Registration No" := CopyrightRegistrationNumber;
