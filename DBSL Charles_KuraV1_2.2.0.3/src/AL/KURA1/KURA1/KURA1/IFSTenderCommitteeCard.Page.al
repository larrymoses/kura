...
Page 75123 "IFS Tender Committee Card"
{
    ...
    PromotedActionCategories = 'New,Process,Report,Committee Functions,Release,Print,Approve,Committee Appointment,Request Approval,Print/Send';
    ...
    layout
    {
        ...
        area(factboxes)
        {
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = All;
                Caption = 'Attachments';
                SubPageLink = "Table ID" = const(70141),
           ...
           group(Approval)
            ...
            action("Print Appointment Letter")
            {
                ...
                begin
                    Rec.Reset;
                    Rec.SetRange("Document No.", Rec."Document No.");
                    Report.Run(Report::"Tender Committee appointment", true, true, Rec);
                end;
            }
            action("Print  Appointment Letter")
            {
