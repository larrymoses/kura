    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Opportunity Reference"; "Opportunity Reference")
                {
                    ApplicationArea = Basic;
                    Visible = false;
                }
                field("Fund Opportunity Name"; "Fund Opportunity Name")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    Visible = false;
                }
                field("Grant Amount"; "Grant Amount")
                {
                    ApplicationArea = Basic;
                    Editable = false;
                    Visible = false;
            ...
            group("Project Details")
            {
                ...
                field("Researcher Code"; "Researcher Code")
                {
                    ApplicationArea = Basic;
                }
            }
