page 50114 "PC Sum Request Card"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("C.I.T"; rec."C.I.T") { ApplicationArea = basic; }
            ...
            part(Control32; "Requested Bill Categories")
            {
                Caption = 'Requested Bill Categories';
    ...
    actions
    {
        area(navigation)
        {
            ...
            action(Committee)
            {
                ...
                RunPageLink = "Document No." = field("C.I.T");//,Type=const(Contract);
            }
    ...
    begin
        Rec.Status := Rec.Status::Open;
        Rec."Document Type" := Rec."document type"::"PC Sum Request";
