...
Page 72488 "Project Variation Order"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Contractor Variation Req No."; "Contractor Variation Req No.")
                {
                    ApplicationArea = Basic;
                }
        ...
        area(navigation)
        {
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    Message(Format("Document Type") + '  ' + "Document No." + ' ' + 'posted sucessfuly.');
                    CurrPage.Close();
                end;
            }
            action(Release)
    ...
    begin
        "Document Type" := "document type"::"Project Variation Order";
    end;
