                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        if InterfundLine.FindSet then begin
                            repeat
                                LineNumber := LineNumber + 1000;
                                FundsAccounting.FnPostInterfundDebit(JTemplate, JBatch, LineNumber, "Document Date", Genline."document type"::" ", No, "External Document No.", Genline."account type"::"G/L Account", InterfundLine."Transfer-From Expense G/L A/C",
