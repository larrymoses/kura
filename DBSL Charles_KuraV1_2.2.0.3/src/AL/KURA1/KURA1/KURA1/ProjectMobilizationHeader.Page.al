    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Project Mission"; "Project Mission")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Project Delivery Strategy"; "Project Delivery Strategy")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Defect Liability Start Date"; "Defect Liability Start Date")
                {
                    ApplicationArea = Basic;
                }
                field("Defect Liability End Date"; "Defect Liability End Date")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Funder Address"; "Funder Address")
                {
                    ApplicationArea = Basic;
                }
                field("Funder Address 2"; "Funder Address 2")
                {
                    ApplicationArea = Basic;
                }
                field("Funder Post Code"; "Funder Post Code")
                {
                    ApplicationArea = Basic;
                }
                field("Funder City"; "Funder City")
                {
                    ApplicationArea = Basic;
                }
                field("Funder County"; "Funder County")
                {
                    ApplicationArea = Basic;
                }
