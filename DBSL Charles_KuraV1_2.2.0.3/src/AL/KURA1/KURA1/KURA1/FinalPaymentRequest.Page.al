    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Advance Payment Security ID"; "Advance Payment Security ID")
                {
                    ApplicationArea = Basic;
                }
                field("Advance Pmt Gua. Expiry Date"; "Advance Pmt Gua. Expiry Date")
                {
                    ApplicationArea = Basic;
                }
                field("Performance Security ID"; "Performance Security ID")
                {
                    ApplicationArea = Basic;
                }
                field("Performance Sec. Expiry Date"; "Performance Sec. Expiry Date")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Contractor Request Cert Amount"; "Contractor Request Cert Amount")
                {
                    ApplicationArea = Basic;
                }
                ...
                field("Certified Amount"; "Certified Amount")
                {
                    ApplicationArea = Basic;
                }
        ...
        area(navigation)
        {
            ...
            action(Reopen)
            {
                ...
                begin
                    Status := Status::Open;
                    Modify;
                    Message('The document %1 has been reopened successfully', "Document No.");
                end;
            }
            action(Release)
            {
                ...
                begin
                    ...
                    Modify;
                    Message('The document %1 has been released successfully', "Document No.");
                end;
            }
            action(Approvals)
            {
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    PurchaseHeader."Certificate Number" := "Document No.";
                    PurchaseHeader."Contractor Request No" := "Document No.";
                    PurchaseHeader."Advance Recovery %" := "Less Advance Payment";
                    PurchaseHeader."Retention %" := "Retention %";
                    ...
                    if Job.FindSet then begin
                        Job."Last IPC Number" := "IPC Number";
                        Job.Modify(true);
                    end;
